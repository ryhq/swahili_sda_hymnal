...
class ViewCategorySongs extends StatefulWidget {
  final String title;
  final int from;
  final int to;
  const ViewCategorySongs({super.key, required this.from, required this.to, required this.title});

  @override
  State<ViewCategorySongs> createState() => _ViewCategorySongsState();
}

class _ViewCategorySongsState extends State<ViewCategorySongs> {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                          icon: Consumer<LikedSongs>(
                            builder: (context, likedSongs, child) {
                              final isLiked = likedSongs.isSongLiked(songs['song_id']);
                              return Icon(
                          ...
                          onPressed: () {
                            Provider.of<LikedSongs>(context, listen: false)
                                .toggleLike(songs['song_id']);
                          },
                        ),
                        onTap: () {
                          Navigator.push(
